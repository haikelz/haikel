...
2. Setelah terinstall, ada dua opsi dalam scriptnya, yakni memakai script original yang berbahasa ruby dari Om Bandithijo, atau yang sudah diporting ke bash. Disini saya pilih yang bash aja.
